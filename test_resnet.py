...
if __name__ == "__main__":
    ...
    #model_path_effi7 = "../user_data/model_data/unetplusplus_resnest117_upsample_SoftCE_dice.pth"
    ...
    #output_dir ='../prediction_result8/image20210408_efb7/'
    #output_dir = '../prediction_result8/image20210408_resnet/'
    #output_dir = '../prediction_result8/image20210408_efre/'
    #output_dir = '../prediction_result8/imageSKE1_efb7/'
    output_dir = '../GF_9_traing_prediction/other_119_1/'
    # output_dir = r'G:/深度学习训练数据/2021Tianchi_RS-main/magelabel_64_512/imagelabel_128_prediction_result/'
    test_image_paths = glob.glob(r'G:/深度学习训练数据/Unet_resnet/GF_9_traing_prediction/Gaofen_9bands_256_118model/*.tif')
    addNDVI = False
    batch_size = 16
    num_workers = 8
    ...
    #test_1(model_path_resnest, output_dir, test_loader, addNDVI)
